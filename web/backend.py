...
def main():
    ...
    for type_mds in mds_types:
        createFile(find_MDS(random_samples, type_mds), find_MDS(adaptive_samples, type_mds), type_mds + ".csv")
